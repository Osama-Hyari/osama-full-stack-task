...
const budget_events_listener_1 = require("./budget-events.listener");
let BudgetsModule = class BudgetsModule {
};
exports.BudgetsModule = BudgetsModule;
exports.BudgetsModule = BudgetsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([budget_entity_1.Budget, transaction_entity_1.Transaction]), categories_module_1.CategoriesModule],
        controllers: [budgets_controller_1.BudgetsController],
        providers: [budgets_service_1.BudgetsService, budget_events_listener_1.BudgetEventsListener],
